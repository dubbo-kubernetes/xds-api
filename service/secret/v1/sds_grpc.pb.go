...
type SecretDiscoveryService_DeltaSecretsClient interface {
	Send(*v1.DeltaDiscoveryRequest) error
	Recv() (*v1.DeltaDiscoveryResponse, error)
	grpc.ClientStream
}
...
func (x *secretDiscoveryServiceDeltaSecretsClient) Send(m *v1.DeltaDiscoveryRequest) error {
	return x.ClientStream.SendMsg(m)
}

func (x *secretDiscoveryServiceDeltaSecretsClient) Recv() (*v1.DeltaDiscoveryResponse, error) {
	m := new(v1.DeltaDiscoveryResponse)
...
type SecretDiscoveryService_StreamSecretsClient interface {
	Send(*v1.DiscoveryRequest) error
	Recv() (*v1.DiscoveryResponse, error)
	grpc.ClientStream
}
...
func (x *secretDiscoveryServiceStreamSecretsClient) Send(m *v1.DiscoveryRequest) error {
	return x.ClientStream.SendMsg(m)
}

func (x *secretDiscoveryServiceStreamSecretsClient) Recv() (*v1.DiscoveryResponse, error) {
	m := new(v1.DiscoveryResponse)
	if err := x.ClientStream.RecvMsg(m); err != nil {
		return nil, err
	}
	return m, nil
...
type SecretDiscoveryService_DeltaSecretsServer interface {
	Send(*v1.DeltaDiscoveryResponse) error
	Recv() (*v1.DeltaDiscoveryRequest, error)
	grpc.ServerStream
}
...
func (x *secretDiscoveryServiceDeltaSecretsServer) Send(m *v1.DeltaDiscoveryResponse) error {
	return x.ServerStream.SendMsg(m)
}

func (x *secretDiscoveryServiceDeltaSecretsServer) Recv() (*v1.DeltaDiscoveryRequest, error) {
	m := new(v1.DeltaDiscoveryRequest)
...
type SecretDiscoveryService_StreamSecretsServer interface {
	Send(*v1.DiscoveryResponse) error
	Recv() (*v1.DiscoveryRequest, error)
	grpc.ServerStream
}
...
func (x *secretDiscoveryServiceStreamSecretsServer) Send(m *v1.DiscoveryResponse) error {
	return x.ServerStream.SendMsg(m)
}

func (x *secretDiscoveryServiceStreamSecretsServer) Recv() (*v1.DiscoveryRequest, error) {
	m := new(v1.DiscoveryRequest)
	if err := x.ServerStream.RecvMsg(m); err != nil {
		return nil, err
	}
	return m, nil
